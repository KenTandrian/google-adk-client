 ...
 *
 * @see https://github.com/google/adk-js/blob/main/core/src/auth/auth_tool.ts
 */

import type { AuthCredential } from "./auth_credential";
import type { AuthScheme } from "./auth_schemes";
